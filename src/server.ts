...
setInterval(() => {
  console.log(
    `${sseClientManager.connectedClientsNumber()} Consumer/s connected like now; curentActiveTopics=${sseClientManager
      .getAllActiveTopics()
      .join()}`
  );
}, 60 * 1000);
